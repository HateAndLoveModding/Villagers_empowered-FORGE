...
public class ModEvents {
    ...
    public static void addCustomTrades(VillagerTradesEvent event) {
        ...
        if(event.getType() == ModVillagers.LIFARMIAN.get()) {
            event.getTrades().get(1).add((trader, rand) -> new MerchantOffer(new ItemStack(Items.STICK, 1), new ItemStack(Items.EMERALD, 1), 25,1,0.005F));
            event.getTrades().get(1).add((trader, rand) -> new MerchantOffer(new ItemStack(Items.PAPER, 1), new ItemStack(Items.EMERALD, 1), 25,1,0.005F));}
        if(event.getType() == ModVillagers.LIFARMIAN.get()) {
            event.getTrades().get(2).add((trader, rand) -> new MerchantOffer(new ItemStack(Items.EMERALD, 1), new ItemStack(Items.REDSTONE, 2), 12, 4, 0.02f));
            event.getTrades().get(2).add((trader, rand) -> new MerchantOffer(new ItemStack(Items.EMERALD, 1), new ItemStack(Items.LAPIS_LAZULI, 1), 12, 4, 0.02f));}
        if(event.getType() == ModVillagers.LIFARMIAN.get()) {
            event.getTrades().get(3).add((trader, rand) -> new MerchantOffer(new ItemStack(Items.EMERALD, 1), new ItemStack(Items.GOLDEN_CARROT, 3), 12, 7, 0.03f));
            event.getTrades().get(3).add((trader, rand) -> new MerchantOffer(new ItemStack(Items.EMERALD, 1), new ItemStack(Items.ENDER_PEARL, 1), 12, 7, 0.03f));}
        if(event.getType() == ModVillagers.LIFARMIAN.get()) {
            event.getTrades().get(4).add((trader, rand) -> new MerchantOffer(new ItemStack(Items.EMERALD, 1), new ItemStack(ModItems.BASE_SPAWN_EGG.get(), 1), 12, 9, 0.04f));
            event.getTrades().get(4).add((trader, rand) -> new MerchantOffer(new ItemStack(Items.EMERALD, 1), new ItemStack(Items.ARROW, 16), 12, 9, 0.04f));}
        if(event.getType() == ModVillagers.LIFARMIAN.get()) {
            event.getTrades().get(5).add((trader, rand) -> new MerchantOffer(new ItemStack(Items.EMERALD, 1), new ItemStack(Items.QUARTZ_BLOCK, 1), 12, 10, 0.05f));
        ...
        if(event.getType() == ModVillagers.CREATURE_CARRIER.get()) {
            event.getTrades().get(1).add((trader, rand) -> new MerchantOffer(new ItemStack(Items.EMERALD, 4), new ItemStack(ModItems.BASE_SPAWN_EGG.get(), 1), new ItemStack(Items.ZOMBIE_SPAWN_EGG, 1), 5, 2, 0.02f));
            event.getTrades().get(1).add((trader, rand) -> new MerchantOffer(new ItemStack(Items.EMERALD, 4), new ItemStack(ModItems.BASE_SPAWN_EGG.get(), 1), new ItemStack(Items.SKELETON_SPAWN_EGG, 1), 5, 2, 0.02f));}
        if(event.getType() == ModVillagers.CREATURE_CARRIER.get()) {
        ...
        if(event.getType() == ModVillagers.CREATURE_CARRIER.get()) {
            event.getTrades().get(3).add((trader, rand) -> new MerchantOffer(new ItemStack(Items.EMERALD, 4), new ItemStack(ModItems.BASE_SPAWN_EGG.get(), 1), new ItemStack(Items.COW_SPAWN_EGG, 1), 5, 8, 0.08f));
            event.getTrades().get(3).add((trader, rand) -> new MerchantOffer(new ItemStack(Items.EMERALD, 4), new ItemStack(ModItems.BASE_SPAWN_EGG.get(), 1), new ItemStack(Items.SHEEP_SPAWN_EGG, 1), 5, 8, 0.08f));}
        if(event.getType() == ModVillagers.CREATURE_CARRIER.get()) {
            event.getTrades().get(4).add((trader, rand) -> new MerchantOffer(new ItemStack(Items.EMERALD, 4), new ItemStack(ModItems.BASE_SPAWN_EGG.get(), 1), new ItemStack(Items.BEE_SPAWN_EGG, 1), 5, 10, 0.1f));
